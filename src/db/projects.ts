...
export const allVideoProjects: VideoProject[] = [
  {
    id: "rVVeLdouViU",
    video_title: "What Does a Facebook Engineer's Resume Look Like?",
  ...
  {
    id: "kpJyIq-mvtc",
    video_title: "What is EduNurture360? | Edu Bridge Academy",
    video_description: "The 2024 batch of EduNurture360 has officially launched!",
    tags: [
      "Education",
      "Institute Promo",
      "Voiceover",
  ...
  },
  {
    id: "w72TzfYIsgU",
    video_title:
      "First Flexible Discount System for EdTech – Learn Without Limits!",
    video_description: `First Flexible Discount System for EdTech – Learn Without Limits!`,
  ...
  {
    id: "MCD9uyZT8Y0",
    video_title: "Why is Learning Programming Fundamentals Crucial?",
    video_description: `Learn why jumping into development without mastering fundamentals leads to hurdles—and how to build a rock-solid foundation.`,
    tags: [
      "Programming Basics",
      "Education",
      "Beginner Tips",
  ...
  },
  {
    ...
    video_description: `A single email misconfiguration can ruin your most valuable client relationships and business reputation.`,
  ...
  },
  {
    ...
    video_description: `Websites need to be fast, smart, and intuitive to accelerate your business conversions.`,
  ...
  },
  {
    ...
    video_description: `Getting website traffic but no paying customers? The issue isn't your product—it's your marketing conversion funnel.`,
    tags: [
      "Marketing Strategy",
  ...
  },
  {
    ...
    video_description: `Just one wrong click or unknown link... and within moments, your business could fall victim to a devastating cyber attack.`,
    tags: [
      "Cyber Security",
      "Protection",
      "Ads",

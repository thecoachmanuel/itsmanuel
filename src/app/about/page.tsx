              ...
              header={
                <div className="relative w-full h-full min-h-[28rem] md:min-h-[16rem] rounded-xl overflow-hidden group-hover/bento:scale-[1.02] transition-transform duration-500">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    ...
                    >
                      EMMANUEL<br />
                      <span className="text-blue-500">OLAITAN</span>
                    </m.div>
            ...
            <BentoGridItem
              ...
              header={
                <div className="flex flex-1 h-full w-full items-center justify-between px-6 bg-gradient-to-r from-neutral-900 to-neutral-800 rounded-xl border border-white/5 py-4 md:py-0 min-h-[5rem]">
                  <a href="https://linkedin.com/in/emmanuel-olaitan" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-[#0077b5] hover:scale-110 transition-all duration-300 text-white"><Linkedin size={20} /></a>
                  <a href="https://instagram.com/editbymanuel" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-pink-600 hover:scale-110 transition-all duration-300 text-white"><Instagram size={20} /></a>
                  <a href="https://youtube.com/@thecoachmanuel" target="_blank" className="p-3 bg-white/5 rounded-full hover:bg-red-600 hover:scale-110 transition-all duration-300 text-white"><Youtube size={20} /></a>
                </div>
              }
              className="h-full"
